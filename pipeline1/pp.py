...
hg_BERT = pipeline('question-answering', model="distilbert-base-uncased-distilled-squad", tokenizer="distilbert-base-uncased-distilled-squad")
...
df_new.to_csv("pfs/out/database.csv", index=False, header=False)
